...
void DJETLoss::collectDescriptorDistance( cv::Mat& y_k, std::shared_ptr<KeyPoint2> kpt2, cv::Mat& A )
{
    double y_k_x, y_k_y;
    ...
    local_kpts = this->generateLocalKpts( y_k_x, y_k_y, kpt2->getSize(), this->img );
