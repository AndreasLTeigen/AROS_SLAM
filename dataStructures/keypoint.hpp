...
class KeyPoint2
{
    ...
    public:
        KeyPoint2( int kpt_id, cv::Point pt, int observation_frame_nr );
        ...
        static void drawEnhancedKeyPoint( cv::Mat &canvas, cv::Mat &img, std::shared_ptr<KeyPoint2> kpt, cv::Point loc_canvas, cv::Size size, cv::Mat F_matrix, std::shared_ptr<KeyPoint2> matched_kpt=nullptr );
